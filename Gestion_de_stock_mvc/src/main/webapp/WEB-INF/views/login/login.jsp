...
<head>
   ...
   <title>Application De gestion de fournisseur </title>
...
<body>
    ...
    <script src="<%request.getContextPath(); %>/ressources/vendor/metisMenu/metisMenu.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="<%request.getContextPath(); %>/ressource/dist/js/sb-admin-2.js"></script>
