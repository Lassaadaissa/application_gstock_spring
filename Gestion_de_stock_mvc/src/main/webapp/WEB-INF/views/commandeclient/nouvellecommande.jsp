    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message key = "commande.client.nouveau" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
			...
			<fmt:message key="commande.client.article.not.found"></fmt:message>
            </div>
           <div class="alert alert-danger" id="clientNotSelectedMsgBlock">
			<fmt:message key="commande.client.select.client.msfg.erreur"></fmt:message>
            </div>
  			<div class="alert alert-danger" id="unexpectedErrorMsgBlock">
			<fmt:message key="commande.client.select.client.unexpected.error"></fmt:message>
            </div>	          
                        ...
                        <div class="panel-body">
							<form action="/commandeClient/enregistrerCommande" enctype="multipart/form-data" role = "form">
								<div class="form-row">
									...
									<div class="col-md-4 mb-3">
	                                    <label><fmt:message key="common.client" /></label>
	                                    <select class = "form-control" id="listClients">
	                                    	<option value="-1"><fmt:message key="commande.client.select.client"/></option>
                                ...
                                <div class="panel-footer">
                                	<button type="button" id="btnEnrigtrerCommande" class="btn btn-primary"><i class="fa fa-save">&nbsp;<fmt:message key="common.enregister" /></i></button>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                        	<div class="form-row">
		                        <div class="col-md-4 mb-3">
		                        	<label><fmt:message key="common.article" /></label>
