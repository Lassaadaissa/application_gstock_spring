...
<!-- MetisMenu CSS -->
<link href="<%=request.getContextPath()%>/resources/vendor/metisMenu/metisMenu.min.css"
	rel="stylesheet">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><fmt:message key="common.confirm.supppression" /></h4>
                                        </div>
                                        <div class="modal-body">
												<fmt:message key="common.confirm.supppression.message" />
                                        </div>
                                        <div class="modal-footer">
                                           ...
                                           <c:url value="/client/supprimer/${client.getIdClient() }" var="urlSupprimer"/>
                                            <a href="${urlSupprimer }"  class="btn btn-danger"><i class="fa fa-trash-o"></i>&nbsp;<fmt:message key="common.confirmer" /></a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
